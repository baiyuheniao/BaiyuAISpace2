...
`.Codex/skills/run-baiyuaispace2/driver.mjs`, which talks to the running
...
```bash
node .Codex/skills/run-baiyuaispace2/driver.mjs launch
node .Codex/skills/run-baiyuaispace2/driver.mjs screenshot out.png
node .Codex/skills/run-baiyuaispace2/driver.mjs nav mcp
node .Codex/skills/run-baiyuaispace2/driver.mjs click "本地部署"
node .Codex/skills/run-baiyuaispace2/driver.mjs eval "document.title"
node .Codex/skills/run-baiyuaispace2/driver.mjs quit
```
